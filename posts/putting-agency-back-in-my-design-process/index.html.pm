...
◊h1{Putting Agency back in My Design Process}
◊posting-date{2025-09-26}

◊section{
  I have been thinking about how Stephen Meyer said that top-down design implies intention or agency (◊a[#:href "https://youtu.be/rXexaVsvhCM"]{source}). I want to look at how that applies to my approach in software design, because I think my recent design work has unfortunately lacked agency. My knowledge of programming leads me to a systems-level or a bottom-up design process, but that design process struggles due to mathematical reasons.
...
◊figure[#:class "fullwidth"]{
  ◊img[#:src "./search-space-example.svg"]
}
...
◊h2{Search Space Pruning}

◊section{
  When I was younger, I loved chess engines. I always wanted to write my own. I gave it a few tries (mostly using F#), but I never got very far because it is one of those programming problems that is easy to do poorly, but very difficult to do well. One of the ideas you will run into if you research chess engines is the idea of pruning. ◊a[#:href "https://www.chessprogramming.org/Pruning"]{ChessProgramming.org} refers to pruning as "a name for every heuristic that removes completely certain branches of the search tree."
