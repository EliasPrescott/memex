...
◊h1{Study of Philippians 2:12-30}

◊posting-date{2025-03-27}

◊callout{
  I have recently switched to using the ◊a[#:href "https://csbible.com/"]{Christian Standard Bible (CSB)} for most of my private study and verse references.
...
◊section{
  ...
  Paul is writing this book from prison, likely in Rome, Caesarea, or possibly ◊a[#:href "https://hermeneutics.stackexchange.com/a/77731"]{in Ephesus}.
...
◊bible-reference{Philippians 2:12 (CSB)}
...
◊bible-reference{Philippians 2:13 (CSB)}
...
◊bible-reference{Philippians 2:14-16 (CSB)}
...
◊bible-reference{Philippians 2:17-18 (CSB)}
...
◊bible-reference{Philippians 2:19-30 (CSB)}
...
◊section{
  ...
  ◊ol{
   ◊li{How do you think God has been working in your life recently?}
   ◊li{What is something that you grumble about, and what could you start doing instead of grumbling?}
   ◊li{Do you ever joyful? When? Or why?}
   ◊li{What is something you could do to engage more with your fellow Christians?}
  }
}
